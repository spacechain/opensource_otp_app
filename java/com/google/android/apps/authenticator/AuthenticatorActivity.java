...
public class AuthenticatorActivity extends TestableActivity {
    ...
    @Inject
    BarcodeConditionChecker barcodeConditionChecker;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.add_account_button_by_spc)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                startActivity(new Intent(AuthenticatorActivity.this, AddKeyValueActivity.class));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.how_it_works) {
            ...
            showSettings();
            return true;
        }else if (item.getItemId() == R.id.spc_main) {
            showSpcMain();
            return true;
        }

//        else if (item.getItemId() == R.id.spc_encrypt) {
//            showSpcEncrypt();
//            return true;
//        } else if (item.getItemId() == R.id.spc_decrypt) {
//            showSpcDecrypt();
//            return true;
//        }
    ...
    private void showSpcMain() {
        startActivity(new Intent(this, SpcMainActivity.class));
    }

    private void showSpcDecrypt() {
        startActivity(new Intent(this, SpcDecryptActivity.class));
    }

    private void showSpcEncrypt() {
        startActivity(new Intent(this, SpcEncryptActivity.class));
    }
