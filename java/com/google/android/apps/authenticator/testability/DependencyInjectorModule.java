...
public class DependencyInjectorModule {
  ...
  private SpcAccountDb sAccountDb;
  ...
  public synchronized SpcAccountDb getSpcAccountDb() {
    if (sAccountDb == null) {
      sAccountDb = createSpcAccountDb();
    }
    return sAccountDb;
  }
  ...
  protected SpcAccountDb createSpcAccountDb() {
    return new SpcAccountDb(getContext());
  }
